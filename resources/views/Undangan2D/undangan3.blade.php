                ...
                <div class="flex justify-center items-center w-full h-screen text-center">
                    <div class="grid grid-cols-1 gap-1.5 w-10/12">
                        <div class="rounded-xl p-2 shadow-2xl fade-scroll">
                            ...
                            <div class="flex justify-center items-center">
                                <a href="{{$undangan->maps_akad}}" class="mt-1 px-0.5 py-1.5 w-8/12 rounded-xl bg-gray-400 flex justify-center items-center">
                        ...
                        <div class="rounded-xl p-2 shadow-2xl mt-5 mb-5 fade-scroll">
                            ...
                            <div class="flex justify-center items-center">
                                <a href="{{$undangan->maps_resepsi}}" class="mt-1 px-0.5 py-1.5 w-8/12 rounded-xl bg-gray-400 flex justify-center items-center">
                                    <i data-lucide="map-minus" class="w-5 h-5 mr-2"></i>
                                    <span class="text-gray-600">Buka Google Lokasi</span>
                                </a>
                            </div>
            ...
            <div class="relative bg-cover1 w-full md:w-8/12 h-screen overflow-hidden z-10">
                ...
                <div class="flex justify-center items-center w-full h-screen pt-10 pb-10">
                    <div class="overflow-y-auto max-h-screen px-4 min-h-0">
                        ...
                        <div class="relative border-l-4 border-gray-500 pl-6 space-y-4 ml-2">
                ...
                <div class="w-full flex justify-center items-center fade-scroll">
                    <form action="{{route('kirim_pesan')}}" method="post">
                        ...
                        <div class="w-full p-2">
                            <label>Nama</label>
                            <input type="hidden" name="slug" value="{{$undangan->slug}}" class="w-full bg-white border-gray-500 outline-1 decoration-0 hover:border-2 hover:border-gray-500 py-1.5 px-3 rounded-lg">
                            <input type="hidden" name="kode_pesan" value="{{$undangan->kode_pesan}}" class="w-full bg-white border-gray-500 outline-1 decoration-0 hover:border-2 hover:border-gray-500 py-1.5 px-3 rounded-lg">
