...
<head>
    ...
    <style>
        ...
        .bg-cover1 {
            background-image: url('/images/bgcover3.png');
        ...
        .bunga {
            background-image: url('/images/daun6.png');
            background-repeat: no-repeat;
    ...
    <section id="cover">
        <div class="w-full flex justify-center">
            <div class="relative bg-cover1 w-full md:w-8/12 h-screen overflow-hidden z-10">
                ...
                <div class="absolute -top-10 md:-top-80 left-0 w-full overflow-hidden">
                    <img src="{{ asset('images/daun6.png') }}"
                        class="w-full h-[90%] object-cover rotate-180 opacity-70"
                        style="animation: angin-top 6s ease-in-out infinite;">
                </div>

                <div class="absolute -bottom-10 md:-bottom-80 right-0 w-full overflow-hidden">
                    <img src="{{ asset('images/daun6.png') }}"
                        class="w-full h-[90%] object-cover opacity-70 rotate-180"
                        style="animation: angin-bottom 8s ease-in-out infinite;">
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-5">
                    <div class="col-span-2">
                        <div class="flex justify-center">
                            <div>
                                <div class="flex justify-center items-center">
                                    <div class="fade-scroll w-36 md:w-64 h-46 md:h-80 rounded-b-full rounded-t-full bg-gray-500 opacity-65 p-0.5">
