<meta charset="utf-8">
    ...
    <style>
        ...
        .bg-cover1 {
            background-image: url('/images/ruangan kerja.jpg');
...
<body class="overflow-x-hidden lock-scroll">
    ...
    <section id="cover_undangan">
        <div class="flex justify-center items-center">
            <div class="relative w-full md:w-6/12 h-screen flex items-center justify-center overflow-hidden">
                ...
                <div class="absolute inset-0 bg-amber-100/40"></div>

                <div class="relative z-10 flex flex-col justify-center items-center w-full h-full text-center px-6">

                    <div class="mb-4 fade-scroll text-white">
                        <h2 style="font-family: 'Sacramento', cursive; font-size: 38px;" class="tracking-wide drop-shadow-md">
                            Wedding Of
                        </h2>
                    </div>

                    <div class="w-48 h-48 md:w-64 md:h-64 rounded-full overflow-hidden ring-8 ring-white/40 shadow-2xl fade-scroll">
                        <img src="{{ asset('storage/'.$images->foto_cover) }}"
                            class="w-full h-full object-cover object-center">
                    </div>

                    <div class="mt-6 max-w-md fade-scroll text-white">
                        <p class="mt-1 font-semibold" style="font-family: 'Sacramento', cursive; font-size: 36px;"> 
                            {{$undangan->judul_undangan}}
                        </p>
                        <span class="block text-sm md:text-base leading-relaxed">
                            Kepada Yth. Bapak/Ibu/Saudara/i
                        </span>
                        <p class="mt-3" style="font-family: 'Sacramento', cursive; font-size: 26px;">{{$tamu}}</p>
                        <p class="mt-3 text-xs md:text-sm tracking-wider">*Mohon maaf apabila ada kesalahan pada
                                                penulisan nama dan gelar</p>
                    </div>
                    <div class="mt-2 w-full flex justify-center items-center muncul2 text-gray-600 font-bold" style="animation-delay: 5.9s;">
                        <a href="#isi_undangan" id="btnBuka" class="bg-amber-100 hover:bg-amber-200 p-3 rounded-lg flex justify-center items-center">
    ...
    <section id="isi_undangan" class="hidden">
        <div class="w-full h-screen overflow-hidden flex justify-center">
            ...
            <div class="relative w-full md:w-6/12 h-screen bg-cover1 flex justify-center overflow-hidden">
                ...
                <div class="absolute top-10 md:top-20 w-full flex justify-center">
        
                    <button class="icon relative group focus:outline-none" data-name="gallery">
                        <img src="{{ url('/images/gallery.png') }}" 
                            class="w-30 h-30 md:w-40 md:h-40 animate-pulse 
                            drop-shadow-[0_0_20px_rgba(0,255,255,0.8)]">

                        <img src="{{ asset('storage/'.$images->foto_cover) }}" 
                            class="absolute inset-0 w-24 h-16 rotate-12 
                            top-[24px] left-3 md:top-[30px] md:left-4 
                            md:w-32 md:h-24">
                        ...
                        transition duration-300">
                            <p class="text-white font-bold text-lg">Gallery</p>
                        </div>

                    </button>

                </div>
                <div class="absolute top-48 -left-2 md:top-80 md:left-48">
        
                    <button class="icon relative group focus:outline-none" data-name="maps">
                        
                        <img src="{{ url('/images/globe.png') }}" 
                        ...
                        md:group-hover:opacity-100
                        transition duration-300">
                            <p class="text-white font-bold text-lg">Maps</p>
                        </div>

                    </button>

                </div>
                <div class="absolute bottom-52 -left-2 md:bottom-[335px] md:left-48">
                    <button class="icon relative group focus:outline-none" data-name="hadiah">
                        <img src="{{ url('/images/hadiah.png') }}" 
                        class="w-24 h-24 md:w-32 md:h-32 animate-pulse drop-shadow-[0_0_20px_rgba(0,255,255,0.8)]">
                        <div class="absolute inset-0 flex items-center justify-center 
                        opacity-0 group-focus:opacity-100 
                        md:group-hover:opacity-100
                        transition duration-300">
                            <p class="text-white font-bold text-lg">Hadiah</p>
                        </div>
                    </button>
                </div>
                <div class="absolute bottom-24 md:bottom-40 w-full flex justify-center">
                    <button class="icon relative group focus:outline-none" data-name="story">
                        <img src="{{ url('/images/laptop.png') }}" 
                        class="w-36 h-36 md:w-52 md:h-52 animate-pulse drop-shadow-[0_0_20px_rgba(0,255,255,0.8)]">
                        <div class="absolute inset-0 flex items-center justify-center 
                        opacity-0 group-focus:opacity-100 
                        md:group-hover:opacity-100
                        transition duration-300">
                            <p class="text-white font-bold text-lg">Story</p>
                        </div>
                    </button>
                </div>
                <div class="absolute bottom-28 right-10 md:bottom-44 md:right-72">
                    <button class="icon relative group focus:outline-none" data-name="tanggal">
                        
                        <img src="{{ url('/images/kalender.png') }}" 
                            class="w-20 h-20 md:w-28 md:h-28 animate-pulse drop-shadow-[0_0_20px_rgba(0,255,255,0.8)]">

                        <div class="absolute inset-0 flex flex-col items-center justify-center text-center">
                            <h1 class="text-[10px] font-semibold text-white -mt-4 md:text-sm">JAN</h1>
                            <p class="text-2xl md:text-4xl font-extrabold leading-none text-black -ml-2">04</p>
                        </div>
                        ...
                        md:group-hover:opacity-100
                        transition duration-300">
                            <p class="text-white font-bold text-sm">Tanggal Acara</p>
                        </div>

                    </button>
                </div>
                <div class="absolute bottom-[90px] right-20 md:bottom-36 md:right-[335px]">
                    <button class="icon relative group focus:outline-none" data-name="guest">
                        <img src="{{ url('/images/amplop.png') }}" 
                        class="w-14 h-14 animate-pulse drop-shadow-[0_0_20px_rgba(0,255,255,0.8)]">
                        <div class="absolute inset-0 flex items-center justify-center 
                        opacity-0 group-focus:opacity-100 
                        md:group-hover:opacity-100
                        transition duration-300">
                            <p class="text-white font-bold text-sm">Guest</p>
                        </div>
                    </button>
                </div>
                <div class="absolute bottom-20 left-10 md:bottom-32 md:left-72">
                    <button class="icon relative group focus:outline-none" data-name="daftarTamu">
                        <img src="{{ url('/images/daftar tamu.png') }}" 
                        class="w-18 h-18 md:w-28 md:h-28 animate-pulse drop-shadow-[0_0_20px_rgba(0,255,255,0.8)]">
                        <div class="absolute inset-0 flex items-center justify-center 
                        opacity-0 group-focus:opacity-100 
                        md:group-hover:opacity-100
                        transition duration-300">
                            <p class="text-white font-bold text-sm">Daftar Tamu</p>
                        </div>
                    </button>
                </div>
            </div>
    ...
    <div id="modal-maps" class="modal hidden fixed inset-0 bg-black/60 flex items-center justify-center transition-all duration-300 z-50 p-3 sm:p-4">

        <!-- Container Utama: Menggunakan max-w-2xl untuk lebar ideal, max-h-[85vh] agar aman dari kepentok layar -->
        <div class="bg-undangan w-full max-w-lg rounded-2xl shadow-2xl flex flex-col h-auto max-h-[85vh] relative overflow-hidden">
            
            <!-- Header Sticky: Judul & Tombol Tutup tetap di atas saat konten di-scroll -->
            <div class="p-5 border-b border-gray-100 flex items-center justify-between sticky top-0 bg-white z-20">
                <div class="flex items-center gap-2 text-red-900">
                    <i data-lucide="message-square-heart" class="w-6 h-6"></i>
                    <h1 style="font-family: 'Sacramento', cursive; font-size: 30px;" class="leading-none">Lokasi</h1>
                </div>
                <button onclick="closeModal()" class="px-4 py-1.5 bg-red-400 hover:bg-red-500 text-white font-medium text-sm rounded-lg transition-colors shadow-sm cursor-pointer">
                    Tutup
                </button>
            </div>
            <!-- Body Content Area: Scrollable secara mandiri -->
            <div class="overflow-y-auto p-5 space-y-6 min-h-0">
                <div class="grid grid-cols-1 gap-4 w-full md:h-[700px] h-screen">
                    
                    <div class="rounded-xl p-4 shadow-xl bg-red-300/90 flex flex-col items-center">
                        <h1 style="font-family: 'Sacramento', cursive; font-size: 32px;" class="mb-1">Akad Nikah</h1>
                        <p class="text-xs md:text-base font-semibold">{{ \Carbon\Carbon::parse($undangan->tgl_akad)->locale('id')->translatedFormat('l, d F Y') }}</p>
                        <p class="text-xs md:text-sm mt-1">Pukul {{ \Carbon\Carbon::parse($undangan->tgl_akad)->locale('id')->translatedFormat('H:i') }} {{$timezone}} - Pukul {{ \Carbon\Carbon::parse($undangan->tgl_resepsi)->locale('id')->translatedFormat('H:i') }} {{$timezone}}</p>
                        <p class="text-xs mt-2 text-red-950 bg-white/20 px-3 py-1.5 rounded-lg w-full max-w-md"><b>Tempat :</b> {{$undangan->alamat_akad}}</p>
                        
                        <a href="{{$undangan->maps_akad}}" target="_blank" class="mt-4 px-4 py-2 w-full max-w-xs rounded-xl bg-white flex justify-center items-center shadow hover:bg-gray-100 transition-colors">
                            <i data-lucide="map-minus" class="w-5 h-5 mr-2 text-red-900"></i>
                            <span class="text-red-900 font-medium text-sm">Buka Google Lokasi</span>
                        </a>
                    </div>

                    <div class="rounded-xl p-4 shadow-xl bg-red-300/90 flex flex-col items-center">
                        <h1 style="font-family: 'Sacramento', cursive; font-size: 32px;" class="mb-1">Resepsi</h1>
                        <p class="text-xs md:text-base font-semibold">{{ \Carbon\Carbon::parse($undangan->tgl_resepsi)->locale('id')->translatedFormat('l, d F Y') }}</p>
                        <p class="text-xs md:text-sm mt-1">Pukul {{ \Carbon\Carbon::parse($undangan->tgl_resepsi)->locale('id')->translatedFormat('H:i') }} {{$timezone}} - Selesai</p>
                        <p class="text-xs mt-2 text-red-950 bg-white/20 px-3 py-1.5 rounded-lg w-full max-w-md"><b>Tempat :</b> {{$undangan->alamat_resepsi}}</p>
                        
                        <a href="{{$undangan->maps_resepsi}}" target="_blank" class="mt-4 px-4 py-2 w-full max-w-xs rounded-xl bg-white flex justify-center items-center shadow hover:bg-gray-100 transition-colors">
                            <i data-lucide="map-minus" class="w-5 h-5 mr-2 text-red-900"></i>
                            <span class="text-red-900 font-medium text-sm">Buka Google Lokasi</span>
                        </a>
                    </div>
    ...
    <!-- Backdrop Modal: Menggunakan p-4 agar ada ruang di pinggir layar HP -->
    <div id="modal-gallery" class="modal hidden fixed inset-0 bg-black/90 flex items-center justify-center transition-all duration-300 z-50 p-4 select-none">

        <!-- Container Utama: Dibuat hitam/transparan khas galeri foto agar fokus ke gambar -->
        <div class="relative w-full max-w-4xl h-[85vh] md:h-[80vh] flex flex-col justify-between overflow-hidden">
            
            <!-- Header Galeri: Judul & Tombol Tutup ditaruh di atas agar mudah dijangkau -->
            <div class="flex items-center justify-between w-full pb-3 z-20 text-white border-b border-white/10">
                <h2 class="text-lg font-semibold tracking-wide">Gallery</h2>
                <button onclick="closeModal()" class="px-4 py-1.5 bg-red-500 hover:bg-red-600 text-white text-sm font-medium rounded-lg transition-colors shadow cursor-pointer">
                    Tutup
                </button>
            </div>

            <!-- AREA SWIPER (Fleksibel mengisi ruang yang tersedia) -->
            <div class="relative flex-1 w-full my-auto py-4 overflow-hidden min-h-0">
                <div class="swiper mySwiper w-full h-full">
                    <div class="swiper-wrapper">
                        @foreach ($images->gallery as $image)
                            <div class="swiper-slide flex justify-center items-center bg-transparent h-full">
                                <!-- max-h-full & object-contain menjaga gambar tidak melar/gepeng dan pas di bingkai -->
                    ...
                    <!-- Navigasi Swiper (Custom warna via CSS Tailwind utility jika didukung Swiper modern) -->
                    <div class="swiper-pagination !bottom-2"></div>
                    <!-- Navigasi panah otomatis disembunyikan di HP (hidden) dan muncul di desktop (md:flex) -->
                    <div class="swiper-button-next !hidden md:!flex !text-white after:!text-2xl"></div>
                    <div class="swiper-button-prev !hidden md:!flex !text-white after:!text-2xl"></div>
                </div>
            </div>

            <!-- NOTE: Overlay bawaanmu tetap dipertahankan, diposisikan di dalam container relatif -->
            <!-- OVERLAY ATAS -->
            <div class="pointer-events-none absolute top-12 left-0 w-full h-16 z-10 bg-gradient-to-b from-black/20 to-transparent"></div>

            <!-- OVERLAY BAWAH -->
            <div class="pointer-events-none absolute bottom-0 left-0 w-full h-16 z-10 bg-gradient-to-t from-black/20 to-transparent"></div>
        </div>
    ...
    <div id="modal-tanggal" class="modal hidden fixed inset-0 bg-black/60 flex items-center justify-center transition-all duration-300 z-50 p-3 sm:p-4">
        ...
        <div class="bg-undangan w-full max-w-lg rounded-2xl shadow-2xl flex flex-col h-auto max-h-[85vh] relative overflow-hidden">
            ...
            <div class="p-5 border-b border-gray-100 flex items-center justify-between sticky top-0 bg-white z-20">
                <div class="flex items-center gap-2 text-red-900">
                    ...
                    <h1 style="font-family: 'Sacramento', cursive; font-size: 30px;" class="leading-none">Save The Date</h1>
                </div>
                <button onclick="closeModal()" class="px-4 py-1.5 bg-red-400 hover:bg-red-500 text-white font-medium text-sm rounded-lg transition-colors shadow-sm cursor-pointer">
                    Tutup
                </button>
            ...
            <div class="overflow-y-auto p-5 space-y-6 min-h-0 text-white">
                
                <div class="flex justify-center w-full h-screen md:h-[700px] items-center p-2">
                    <div class="w-full">
                        <div class="text-center">
                            <div>
                                <h2 class="text-red-800" style="font-family: 'Sacramento', cursive; font-size: 28px;">
                                    The Wedding Of
                                </h2>
                            </div>
                            <div>
                                <h3 class="text-red-900 font-medium tracking-wide leading-tight px-2" style="font-family: 'Sacramento', cursive; font-size: 46px;">
                            ...
                            @if($undangan->hastag != '-')
                                <div class="pt-1">
                                    <p class="text-gray-500 italic tracking-wider text-sm font-sans">
                                        {{$undangan->hastag}}  
                                    </p>
                                </div>
                            @endif
                        ...
                        <div class="text-center py-3 my-4 border-y border-red-100 max-w-sm mx-auto">
                            <p class="text-gray-700 font-semibold text-base md:text-lg tracking-wide">
                                {{ \Carbon\Carbon::parse($undangan->tgl_akad)->locale('id')->translatedFormat('l, d F Y') }}
                            </p>
                        </div>
                        ...
                        <div class="flex flex-col items-center justify-center space-y-3">
                            ...
                            <div class="grid grid-cols-4 gap-3 w-full px-2">
                                
                                <div class="bg-red-900 text-white p-3 font-bold rounded-xl flex flex-col items-center justify-center shadow-md transition-transform hover:scale-105">
                                    <span id="days" class="text-xl md:text-2xl tracking-tight leading-none">0</span>
                                    <span class="text-[10px] md:text-xs font-medium text-red-200 uppercase tracking-widest mt-1">Days</span>
                                </div>

                                <div class="bg-red-900 text-white p-3 font-bold rounded-xl flex flex-col items-center justify-center shadow-md transition-transform hover:scale-105">
                                    <span id="hours" class="text-xl md:text-2xl tracking-tight leading-none">0</span>
                                    <span class="text-[10px] md:text-xs font-medium text-red-200 uppercase tracking-widest mt-1">Jam</span>
                                </div>

                                <div class="bg-red-900 text-white p-3 font-bold rounded-xl flex flex-col items-center justify-center shadow-md transition-transform hover:scale-105">
                                    <span id="minutes" class="text-xl md:text-2xl tracking-tight leading-none">0</span>
                                    <span class="text-[10px] md:text-xs font-medium text-red-200 uppercase tracking-widest mt-1">Menit</span>
                                </div>

                                <div class="bg-red-500 text-white p-3 font-bold rounded-xl flex flex-col items-center justify-center shadow-md transition-transform hover:scale-105">
                                    <span id="seconds" class="text-xl md:text-2xl tracking-tight leading-none">0</span>
                                    <span class="text-[10px] md:text-xs font-medium text-red-100 uppercase tracking-widest mt-1">Detik</span>
                                </div>
                        ...
                        <div class="flex justify-center pt-5">
                            <a href="https://www.google.com/calendar/render?action=TEMPLATE&text={{ urlencode($title) }}&details={{ urlencode($details) }}&dates={{ $start }}/{{ $end }}&location={{ urlencode($undangan->alamat_akad) }}&ctz=Asia/Jakarta"
                            target="_blank"
                            rel="noopener noreferrer"
                            class="inline-flex items-center justify-center px-6 py-2.5 bg-red-600 hover:bg-red-700 text-white font-semibold text-sm rounded-xl transition-all shadow-md hover:shadow-lg active:scale-95 cursor-pointer w-full max-w-[280px]">
                                <i data-lucide="calendar-fold" class="w-4 h-4 mr-2"></i>
                                Save to Calendar
                            </a>
                        </div>
                    </div>
    ...
    <div id="modal-hadiah" class="modal hidden fixed inset-0 bg-black/60 flex items-center justify-center transition-all duration-300 z-50 p-3 sm:p-4">
        ...
        <div class="bg-undangan w-full max-w-lg rounded-2xl shadow-2xl flex flex-col h-auto max-h-[85vh] relative overflow-hidden">
            ...
            <div class="p-5 border-b border-gray-100 flex items-center justify-between sticky top-0 bg-white z-20">
                <div class="flex items-center gap-2 text-red-900">
                    <i data-lucide="message-square-heart" class="w-6 h-6"></i>
                    <h1 style="font-family: 'Sacramento', cursive; font-size: 30px;" class="leading-none">Kirim Hadiah</h1>
                </div>
                <button onclick="closeModal()" class="px-4 py-1.5 bg-red-400 hover:bg-red-500 text-white font-medium text-sm rounded-lg transition-colors shadow-sm cursor-pointer">
                    Tutup
                </button>
                 ...
                 <!-- Loop Dompet Digital / Kartu ATM -->
                    @foreach ($dompet_digital ?? [] as $dompet)
                        <div class="w-full h-44 md:h-64 relative rounded-xl bg-kartu-atm p-4 flex flex-col justify-between shadow-md overflow-hidden text-white group">
                            ...
                            <!-- Bagian Bawah Kartu: Nomor Rekening & Nama Pemilik -->
                            <div class="space-y-1 mt-auto">
                                <p class="norek-text text-base md:text-lg font-mono tracking-widest font-semibold drop-shadow-sm">
                                    {{ $dompet['no_rek'] }}
                                </p>
                                <div class="flex justify-between items-end">
                                    <div>
                                        <p class="text-[10px] uppercase tracking-wider text-white/70">Card Holder</p>
                                        <p class="text-sm font-medium uppercase tracking-wide drop-shadow-sm">{{ $dompet['an_nama'] }}</p>
                                    </div>
                                    <!-- Tombol Copy Rekening -->
                                    <button onclick="copyNorek(this)" class="flex items-center gap-1.5 px-2.5 py-1 bg-white/20 hover:bg-white/40 active:scale-95 rounded-lg text-xs font-medium transition-all backdrop-blur-sm cursor-pointer">
                                        <i data-lucide="copy" class="w-3.5 h-3.5"></i> Copy
                                    </button>
                                </div>
                                <p class="text-[10px] text-red-100 status-message h-3"></p>
                            </div>
                        </div>
                    @endforeach

                    <!-- Kartu Pengiriman Hadiah Fisik / Alamat -->
                    <div class="w-full rounded-xl bg-red-300 text-white p-5 flex flex-col justify-between shadow-md min-h-[11rem]">
                        <div>
                            <div class="flex items-center gap-2 mb-3 border-b border-white/10 pb-2">
                                <i data-lucide="map-pin" class="w-4 h-4 text-red-300"></i>
                                <h2 class="text-sm font-bold uppercase tracking-wider">Kirim Hadiah Fisik</h2>
                            </div>

                            <!-- Info Detail Alamat -->
                            <div id="data-alamat" class="space-y-2 text-xs md:text-sm text-red-100">
                                <div class="grid grid-cols-4 gap-1 leading-tight">
                                    <span class="opacity-80">Penerima</span>
                                    <span class="col-span-3 font-medium text-white">: {{ $undangan->nama_mempelai_wanita }}</span>
                                </div>
                                <div class="grid grid-cols-4 gap-1 leading-tight">
                                    <span class="opacity-80">Alamat</span>
                                    <span class="col-span-3 font-medium text-white break-words">: {{ $undangan->alamat_kirim_hadiah }}</span>
                                </div>
                            </div>
                        </div>

                        <!-- Tombol Copy Alamat -->
                        <div class="mt-4 pt-2 border-t border-white/10 flex justify-end">
                            <button onclick="copy_alamat()" class="flex items-center gap-1.5 px-3 py-1.5 bg-white/10 hover:bg-white/20 active:scale-95 text-white text-xs font-medium rounded-lg transition-all cursor-pointer">
    ...
    <!-- Backdrop Modal: Menggunakan p-3/p-4 agar pas di layar HP mini tanpa menyentuh tepi layar -->
    <div id="modal-daftarTamu" class="modal hidden fixed inset-0 bg-black/60 flex items-center justify-center transition-all duration-300 z-50 p-3 sm:p-4">
        ...
        <div class="bg-undangan w-full max-w-lg rounded-2xl shadow-2xl flex flex-col h-auto max-h-[85vh] relative overflow-hidden">
            ...
            <div class="p-5 border-b border-gray-100 flex items-center justify-between sticky top-0 bg-white z-20">
                <div class="flex items-center gap-2 text-red-900">
                    <i data-lucide="message-square-heart" class="w-6 h-6"></i>
                    <h1 style="font-family: 'Sacramento', cursive; font-size: 30px;" class="leading-none">Wishes & RSVP</h1>
                </div>
                <button onclick="closeModal()" class="px-4 py-1.5 bg-red-400 hover:bg-red-500 text-white font-medium text-sm rounded-lg transition-colors shadow-sm cursor-pointer">
                    Tutup
                </button>
            ...
            <div class="overflow-y-auto p-5 space-y-6 min-h-0">
                ...
                <!-- SECTION 1: FORM KIRIM PESAN / UCAPAN -->
                <div class="bg-red-50/60 border border-red-100 p-5 rounded-xl space-y-4">
                    <div class="text-center">
                    ...
                    <form action="{{ route('kirim_pesan') }}" method="post" class="space-y-4">
                        @csrf
                        <input type="hidden" name="slug" value="{{ $undangan->slug }}">
                        <input type="hidden" name="kode_pesan" value="{{ $undangan->kode_pesan }}">
                        
                        <div>
                            <label class="block text-xs font-semibold text-gray-700 uppercase tracking-wider mb-1">Nama Anda</label>
                            <input type="text" name="nama" required placeholder="Masukkan nama lengkap"
                                class="w-full bg-white border border-gray-300 focus:border-red-400 focus:ring-2 focus:ring-red-100 outline-none py-2 px-3.5 rounded-lg text-sm transition-all text-gray-800">
                        </div>
                        <div>
                            <label>Konfirmasi</label>
                            <select name="konfirmasi_kehadiran" class="w-full bg-white border border-gray-300 focus:border-red-400 focus:ring-2 focus:ring-red-100 outline-none py-2 px-3.5 rounded-lg text-sm transition-all text-gray-800">
                        ...
                        <div>
                            <label class="block text-xs font-semibold text-gray-700 uppercase tracking-wider mb-1">Pesan / Doa</label>
                            <textarea name="pesan" rows="3" required placeholder="Tuliskan ucapan & doa restu..."
                                    class="w-full bg-white border border-gray-300 focus:border-red-400 focus:ring-2 focus:ring-red-100 outline-none py-2 px-3.5 rounded-lg text-sm transition-all text-gray-800 resize-none"></textarea>
                        </div>

                        <div class="flex justify-end">
                            <button type="submit" class="w-full sm:w-auto px-6 py-2 rounded-lg bg-red-500 hover:bg-red-600 text-white font-medium text-sm transition-all shadow-sm active:scale-95 cursor-pointer">
                                Kirim Pesan
                            </button>
                        </div>
                    </form>
                ...
                <!-- SECTION 2: DAFTAR UCAPAN / FEEDBACK TAMU -->
                <div class="space-y-3">
                    <h3 class="text-xs font-bold text-gray-400 uppercase tracking-widest px-1">Ucapan dari Tamu ({{ count($pesan) }})</h3>
                    
                    <div class="space-y-3">
                        @foreach ($pesan as $message)
                            {{-- Cari data kehadiran yang memiliki nama yang sama dengan nama pengirim pesan --}}
                            @php
                                $hadir = $kehadiran->firstWhere('nama', $message->nama);
                            @endphp

                            <div class="relative flex items-start gap-3 p-4 bg-red-900 text-white rounded-xl shadow-sm">
                                ...
                                @if ($hadir)
                                    <div class="absolute top-3 right-3">
                                        @if ($hadir->konfirmasi_kehadiran == 'Ya, Saya Akan Hadir')
                                            <span class="inline-flex items-center justify-center w-6 h-6 rounded-full bg-emerald-500/20 text-emerald-400 border border-emerald-500/30 shadow-sm" title="Hadir">
                                                <i data-lucide="check" class="w-4 h-4 stroke-[3]"></i>
                                            </span>
                                        @else
                                            <span class="inline-flex items-center justify-center w-6 h-6 rounded-full bg-rose-500/20 text-rose-400 border border-rose-500/30 shadow-sm" title="Tidak Hadir">
                    ...
                    <div class="grid grid-cols-2 gap-3 pt-4 border-t border-gray-200/20 mt-4 px-1">
                        <div class="flex items-center justify-between p-3 bg-emerald-500/10 border border-emerald-500/20 rounded-xl">
                            ...
                            <span class="text-base font-bold text-emerald-400">
                                {{ $kehadiran->where('konfirmasi_kehadiran', 'Ya, Saya Akan Hadir')->count() }}
                            </span>
                        </div>
                ...
                <!-- SECTION 4: AYAT SUCI / FOOTER -->
                <div class="text-center p-5 bg-stone-50 border border-stone-200/60 rounded-xl text-gray-600 space-y-4">
                    <p class="text-xs md:text-sm italic leading-relaxed text-gray-500">
                        "Dan di antara tanda-tanda (kebesaran)-Nya ialah Dia menciptakan pasangan-pasangan untukmu dari jenismu sendiri, agar kamu cenderung dan merasa tenteram kepadanya, dan Dia menjadikan di antaramu rasa kasih dan sayang. Sesungguhnya pada yang demikian itu benar-benar terdapat tanda-tanda (kebesaran Allah) bagi kaum yang berpikir."
                    </p>
                    <p class="text-xs font-bold uppercase tracking-widest text-red-800">
                        (Q.S Ar Rum : 21)
                    </p>
                </div>
    ...
    <div id="modal-guest" class="modal hidden fixed inset-0 bg-black/60 flex items-center justify-center transition-all duration-300 z-50 p-3 sm:p-4">
        ...
        <div class="bg-undangan w-full max-w-lg rounded-2xl shadow-2xl flex flex-col h-auto max-h-[85vh] relative overflow-hidden">
            ...
            <div class="p-5 border-b border-gray-100 flex items-center justify-between sticky top-0 bg-white z-20">
                <div class="flex items-center gap-2 text-red-900">
                    <i data-lucide="message-square-heart" class="w-6 h-6"></i>
                    <h1 style="font-family: 'Sacramento', cursive; font-size: 30px;" class="leading-none">Profil Mempelai</h1>
                </div>
                <button onclick="closeModal()" class="px-4 py-1.5 bg-red-400 hover:bg-red-500 text-white font-medium text-sm rounded-lg transition-colors shadow-sm cursor-pointer">
                    Tutup
                </button>
            ...
            <div class="overflow-y-auto p-5 space-y-6 min-h-0">
                ...
                @if ($undangan->jenis_undangan == 'P')
                    <div class="flex justify-center w-full h-[1400px] items-center p-2">
                        <div>
                            <div class="flex justify-center text-gray-500 mb-2">
                                <!-- Diubah dari md:72 menjadi md:w-72 -->
                            ...
                            <!-- Karakter spasi ilegal sebelum 'flex' sudah dihapus -->
                            <div class="flex justify-center items-center text-center mb-5 text-gray-500">
                            ...
                            <div class="flex justify-center mt-4">
                                <div>
                                    <div class="flex justify-center items-center">
                                        <div class="mt-3">
                                            <div class="flex justify-center mt-1 text-gray-500">
                                                <h1 style="font-family: 'Sacramento', cursive;" class="text-2xl md:text-4xl">{{$undangan->nama_mempelai_wanita}}</h1>
                                            </div>
                                            <div class="opacity-0 mt-4 mb-9 text-gray-500 flex justify-center items-center text-[12px] md:text-[18px] text-center">
                                                <!-- Logika diubah dari <= 0 menjadi > 0 -->
                                                @if ($undangan->nama_ayah_wanita != '-' && $undangan->nama_ibu_wanita != '-' && $undangan->anak_ke > 0)
                                                    <p>Putra ke-{{$undangan->anak_ke}} dari Bapak {{$undangan->nama_ayah_wanita}} dan Ibu {{$undangan->nama_ibu_wanita}}</p>
                                                @endif
                                            </div>
                                            <div class="flex justify-center items-center mb-5">
                                                <div class="w-48 h-72 md:w-64 md:h-64 rounded-full overflow-hidden ring-[14px] ring-white/40 shadow-2xl">
                                                    <img src="{{ asset('storage/'.$images->foto_mempelai_wanita) }}" class="w-full h-full object-cover object-center" alt="mempelai wanita">
                                                </div>
                                            </div>
                                            <div class="mb-3 mt-2">
                                                <div class="flex justify-center items-center">
                                                    @if ($undangan->fb_mempelai_wanita != '-')
                                                        <div class="w-5 h-5 md:w-10 md:h-10 rounded-full overflow-hidden ring-2 ring-white/40 shadow-2xl text-gray-500">
                                                    ...
                                                    @if ($undangan->ig_mempelai_wanita != '-')
                                                        <div class=" w-5 h-5 md:w-10 md:h-10 rounded-full overflow-hidden ring-2 ring-white/40 text-gray-500 shadow-2xl ml-2">
                                        ...
                                        </div> <!-- Penutup div mt-3 -->
                                    </div> <!-- Penutup div flex justify-center items-center -->
                                </div> <!-- Penutup div pembungkus dalam -->
                            </div> <!-- Penutup div flex justify-center mt-4 -->
                            <div class="flex justify-center items-center mb-2 mt-5 fade-scroll tex-gray-500">
                            ...
                            <div class="flex justify-center">
                                <div>
                                    <div class="flex justify-center items-center">
                                        <div class="p-2">
                                            <div class=" text-gray-500 flex justify-center mt-5">
                                                <h1 style="font-family: 'Sacramento', cursive;" class="text-2xl md:text-4xl">{{$undangan->nama_mempelai_pria}}</h1>
                                            </div>
                                            <div class=" text-gray-500 mt-3 flex justify-center items-center text-[12px] md:text-[18px] text-center">
                                                @if ($undangan->nama_ayah_pria != '-' && $undangan->nama_ibu_pria != '-' && $undangan->anak_ke <= 0)
                                                    <p>Putri {{$anak_ke}} dari Bapak {{$undangan->nama_ayah_pria}} dan Ibu {{$undangan->nama_ibu_pria}}</p>
                                                @endif
                                            </div>
                                            ...
                                            <div class="mt-2">
                                                <div class="flex justify-center items-center fade-scroll">
                                                    ...
                                                    @if ($undangan->ig_mempelai_pria != '-')
                                                        <div class=" w-5 h-5 md:w-10 md:h-10 rounded-full overflow-hidden ring-2 ring-white/40 shadow-2xl ml-2 text-gray-500">
                        ...
                        </div> <!-- Penutup div pembungkus utama kedua -->
                    </div> <!-- Penutup div h-[1400px] -->
                @else
                    <div class="flex justify-center w-full h-[1400px] items-center p-2">
                        <div>
                            <div class="flex justify-center text-gray-500 mb-2">
                                    ...
                                    <div class="flex justify-center items-center">
                                        <div class="mt-3">
                                            ...
                                            <div class="opacity-0 mt-4 mb-9 text-gray-500 flex justify-center items-center text-[12px] md:text-[18px] text-center">
                                                <!-- Logika diubah dari <= 0 menjadi > 0 -->
                                                @if ($undangan->nama_ayah_pria != '-' && $undangan->nama_ibu_pria != '-' && $undangan->anak_ke > 0)
                                                    <p>Putra ke-{{$undangan->anak_ke}} dari Bapak {{$undangan->nama_ayah_pria}} dan Ibu {{$undangan->nama_ibu_pria}}</p>
                                                @endif
                                            </div>
                                            <div class="flex justify-center items-center mb-5">
                                                <div class="w-48 h-72 md:w-64 md:h-64 rounded-full overflow-hidden ring-[14px] ring-white/40 shadow-2xl">
                                                    <img src="{{ asset('storage/'.$images->foto_mempelai_pria) }}" class="w-full h-full object-cover object-center" alt="mempelai pria">
                                                </div>
                                            </div>
                                            <div class="mb-3 mt-2">
                                                <div class="flex justify-center items-center">
    ...
    <!-- Backdrop Modal: Menggunakan p-4 agar ada jarak manis di layar HP kecil -->
    <div id="modal-story" class="modal hidden fixed inset-0 bg-black/60 flex items-center justify-center transition-all duration-300 z-50 p-4">

        <!-- Container Utama: Menggunakan max-h-[85vh] agar aman di layar HP pendek & tidak overflow keluar layar -->
        <div class="bg-undangan w-full max-w-lg rounded-2xl shadow-2xl flex flex-col h-auto max-h-[85vh] relative overflow-hidden">
            
            <!-- Header Sticky: Tombol tutup & Judul tidak akan ikut tergulung saat di-scroll -->
            <div class="p-5 border-b border-gray-100 flex items-center justify-between sticky top-0 bg-white z-10">
                <h1 style="font-family: 'Sacramento', cursive; font-size: 32px;" class="text-gray-900 leading-none">
                    Our Story
                </h1>
                <button onclick="closeModal()" class="px-4 py-1.5 bg-red-400 hover:bg-red-500 text-white font-medium text-sm rounded-lg transition-colors shadow-sm cursor-pointer">
                    Tutup
            ...
            <!-- Body Content: Scrollable area jika isi timeline-nya panjang -->
            <div class="overflow-y-auto p-5 md:p-6 space-y-6">
                <div class="relative border-l-2 border-red-300 pl-6 space-y-6 ml-3">

                    <!-- Item 1 -->
                    <div class="timeline-item translate-y-10 transition-all duration-700 relative">
                        <!-- Indikator Lingkaran Timeline Absolut agar posisinya pas di garis -->
                        <div class="absolute -left-[37px] top-1 w-6 h-6 rounded-full bg-red-300 flex text-white justify-center items-center shadow-md">
                            <i data-lucide="heart" class="w-3.5 h-3.5"></i>
                        </div>
                        <div class="rounded-xl w-full p-3.5 shadow-md bg-red-300 text-white text-sm leading-relaxed">
                            <p class="font-bold border-b border-red-200/50 pb-1 mb-1.5">
                                {{ \Carbon\Carbon::parse($stories->tgl_stori_1)->locale('id')->translatedFormat('Y') }}
                            </p>
                            <p>{{ $stories->story_1 }}</p>
                        </div>
                    </div>
                    ...
                    <div class="timeline-item translate-y-10 transition-all duration-700 relative">
                        ...
                        <div class="rounded-xl w-full p-3.5 shadow-md bg-red-300 text-white text-sm leading-relaxed">
                            <p class="font-bold border-b border-red-200/50 pb-1 mb-1.5">
                                {{ \Carbon\Carbon::parse($stories->tgl_stori_2)->locale('id')->translatedFormat('Y') }}
                            </p>
                            <p>{{ $stories->story_2 }}</p>
                        </div>
                    </div>
                    ...
                    <div class="timeline-item translate-y-10 transition-all duration-700 relative">
                        ...
                        <div class="rounded-xl w-full p-3.5 shadow-md bg-red-300 text-white text-sm leading-relaxed">
                            <p class="font-bold border-b border-red-200/50 pb-1 mb-1.5">
                                {{ \Carbon\Carbon::parse($stories->tgl_stori_3)->locale('id')->translatedFormat('Y') }}
                            </p>
                            <p>{{ $stories->story_3 }}</p>
                        </div>
                    </div>
                    ...
                    <!-- Item 4 -->
                    @if ($stories->story_4 && $stories->story_4 != '-')
                    <div class="timeline-item translate-y-10 transition-all duration-700 relative">
                        <div class="absolute -left-[37px] top-1 w-6 h-6 rounded-full bg-red-300 flex text-white justify-center items-center shadow-md">
                            <i data-lucide="heart" class="w-3.5 h-3.5"></i>
                        </div>
                        <div class="rounded-xl w-full p-3.5 shadow-md bg-red-300 text-white text-sm leading-relaxed">
                            <p class="font-bold border-b border-red-200/50 pb-1 mb-1.5">
                                {{ \Carbon\Carbon::parse($stories->tgl_stori_4)->locale('id')->translatedFormat('Y') }}
                            </p>
                            <p>{{ $stories->story_4 }}</p>
                        </div>
                    </div>
                    ...
                    <!-- Item 5 (Perbaikan bug typo tgl_stori_5) -->
                    @if ($stories->story_5 && $stories->story_5 != '-')
                    <div class="timeline-item translate-y-10 transition-all duration-700 relative">
                        <div class="absolute -left-[37px] top-1 w-6 h-6 rounded-full bg-red-300 flex text-white justify-center items-center shadow-md">
                            <i data-lucide="heart" class="w-3.5 h-3.5"></i>
                        </div>
                        <div class="rounded-xl w-full p-3.5 shadow-md bg-red-300 text-white text-sm leading-relaxed">
                            <p class="font-bold border-b border-red-200/50 pb-1 mb-1.5">
                                {{ \Carbon\Carbon::parse($stories->tgl_stori_5)->locale('id')->translatedFormat('Y') }}
                            </p>
                            <p>{{ $stories->story_5 }}</p>
                        </div>
                    </div>
                    ...
                    <!-- Item 6 (Perbaikan bug typo tgl_stori_6) -->
                    @if ($stories->story_6 && $stories->story_6 != '-')
                    <div class="timeline-item translate-y-10 transition-all duration-700 relative">
                        <div class="absolute -left-[37px] top-1 w-6 h-6 rounded-full bg-red-300 flex text-white justify-center items-center shadow-md">
                            <i data-lucide="heart" class="w-3.5 h-3.5"></i>
                        </div>
                        <div class="rounded-xl w-full p-3.5 shadow-md bg-red-300 text-white text-sm leading-relaxed">
                            <p class="font-bold border-b border-red-200/50 pb-1 mb-1.5">
                                {{ \Carbon\Carbon::parse($stories->tgl_stori_6)->locale('id')->translatedFormat('Y') }}
                            </p>
                            <p>{{ $stories->story_6 }}</p>
                        </div>
                    </div>
    ...
    <div id="imageModal" class="fixed inset-0 bg-black/90 hidden justify-center items-center z-50">
        <span class="absolute top-5 right-5 text-white text-3xl focus:outline-none" onclick="tutupModal()">&times;</span>
   ...
   <script>
        ...
        // Ambil element cover Anda (ganti 'cover_undangan' dengan ID section cover Anda yang sebenarnya jika berbeda)
        const coverUndangan = document.getElementById('cover_undangan') || btnBuka.closest('section');

        btnBuka.addEventListener('click', function (e) {
            e.preventDefault();
            
            // 1. Sembunyikan halaman cover agar tidak bisa di-scroll ke atas lagi
            if (coverUndangan) {
                coverUndangan.classList.add('hidden');
            }
            
            // 2. Munculkan halaman isi undangan
            isiUndangan.classList.remove('hidden');
            
            // 3. Paksa layar browser kembali ke koordinat paling atas (0,0) secara instan
            window.scrollTo({ top: 0, behavior: 'instant' });
            
            // 4. Pastikan body tetap terkunci (menghindari scroll darurat di beberapa HP)
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function () {
            ...
            function openModal(name) {
                ...
                if (!modal) {
                    console.error('Modal tidak ditemukan:', name);
                    return;
                }
            ...
            // biar tombol close tetap bisa dipakai
