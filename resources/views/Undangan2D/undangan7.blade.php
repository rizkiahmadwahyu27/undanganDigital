<meta charset="utf-8">
    ...
    <style>
        ...
        .bg-cover1 {
            background-image: url('/images/Wedding png.jpg');
        ...
        .bunga {
            background-image: url('/images/bunga17.png');
            background-repeat: no-repeat;
...
<body class="overflow-x-hidden lock-scroll">
    ...
    <section id="cover">
        <div class="w-full flex justify-center">
            <div class="relative bg-cover1 w-full md:w-6/12 h-screen overflow-hidden z-10">
                ...
                <!-- DAUN TOP -->
                <div class="absolute -top-20 -left-10 bunga w-56 h-56 md:w-96 md:h-96 opacity-70 rotate-0"
                    style="animation-name: angin-top; animation-delay: 0.5s;"></div>
                <div class="absolute -top-10 -right-20 bunga w-56 h-56 md:w-96 md:h-96 opacity-70 rotate-90"
                    style="animation-name: angin-top; animation-delay: 0.5s;"></div>

                {{-- Daun Bottom --}}
                <div class="absolute -bottom-10 -left-20 bunga w-56 h-56 md:w-96 md:h-96 opacity-70 rotate-270"
                    style="animation-name: angin-top; animation-delay: 0.5s;"></div>
                <div class="absolute -bottom-20 -right-10 bunga w-56 h-56 md:w-96 md:h-96 opacity-70 rotate-180"
                    style="animation-name: angin-top; animation-delay: 0.5s;"></div>
                    ...
                    <div>
                        ...
                        <div class="w-full flex justify-center items-center opacity-0 animate-fadeCover -mt-1">
                            <div>
                                ...
                                <div class="flex justify-center items-center">
                                    <p class="text-gray-600 text-xl font-bold">{{$tamu}}</p>
                                </div>
                        ...
                        <div class="mt-2 w-full flex justify-center items-center opacity-0 animate-fadeCover text-yellow-200">
                            <a href="#isi_undangan" id="btnBuka" class="bg-yellow-600 hover:bg-yellow-500 p-3 rounded-lg flex justify-center items-center">
    ...
    <section id="isi_undangan" class="hidden">
                ...
                <div class="w-full h-screen flex justify-center items-center">
                    <div>
                            ...
                            <div>
                                <div id="countdown" class="mt-2 fade-scroll flex justify-center items-center text-xl md:text-3xl font-bold"></div>
                                    <div class="grid grid-cols-4 gap-4">
                                        <div class="opacity-0 fade-scroll bg-yellow-300 scale-anim w-18 h-18 p-1 font-bold text-yellow-600 rounded-tl-xl rounded-br-xl flex justify-center items-center">
                                            <div class="flex justify-center items-center">
                                                <div>
                                                    <p id="days">0</p>
                                                    <p>Days</p>
                        ...
                        <div class="flex justify-center items-center mt-10">
                            <div class="opacity-0 fade-scroll bg-yellow-300 rounded-xl p-3 text-yellow-700 font-bold">
        ...
        <div class="w-full flex justify-center items-center">
            <div class="relative bg-cover1 w-full md:w-6/12 h-screen overflow-hidden z-10">
               <div class="bubble-wrapper absolute inset-0 z-0 pointer-events-none">
                ...
                <div class="absolute -bottom-20 -right-10 bunga w-56 h-56 md:w-96 md:h-96 opacity-70 rotate-180"
                    style="animation-name: angin-top; animation-delay: 0.5s;"></div>
                <div class="flex justify-center items-center w-full h-screen text-gray-800">
                    <div>
                        <div class="flex justify-center -mt-10 text-gray-800 mb-2">
                                    ...
                                    <div>
                                        ...
                                        <div class="flex justify-center items-center">
                                            <div class="mt-6">
                                                ...
                                                <div class="mt-1">
                                                    <div class="flex justify-center items-center">
                                                        <div class="fade-scroll w-5 h-5 md:w-10 md:h-10 rounded-full overflow-hidden ring-2 ring-white/40 shadow-2xl text-gray-800">
                                                        ...
                                                        <div class="fade-scroll w-5 h-5 md:w-10 md:h-10 rounded-full overflow-hidden ring-2 ring-white/40 shadow-2xl ml-2 text-gray-800">
                                            ...
                                            <div class="p-2">
                                                ...
                                                <div class="mb-3 mt-1">
                                                    <div class="flex justify-center items-center">
                                                        ...
                                                        <div class="fade-scroll w-5 h-5 md:w-10 md:h-10 rounded-full overflow-hidden ring-2 ring-white/40 text-gray-800 shadow-2xl ml-2">
        ...
        <div class="w-full flex justify-center items-center">
            <div class="relative bg-cover1 w-full md:w-6/12 h-screen overflow-hidden z-10">
               <div class="bubble-wrapper absolute inset-0 z-0 pointer-events-none">
                ...
                <div class="absolute -bottom-20 -right-10 bunga w-56 h-56 md:w-96 md:h-96 opacity-70 rotate-180"
                    style="animation-name: angin-top; animation-delay: 0.5s;"></div>
                <div class="flex justify-center items-center w-full h-screen text-center text-gray-800">
                        ...
                        <div class="rounded-xl p-2 shadow-2xl fade-scroll">
                            ...
                            <div class="flex justify-center items-center">
                                <a href="{{$undangan->maps_akad}}" class="mt-1 px-0.5 py-1.5 w-8/12 rounded-xl bg-yellow-400 flex justify-center items-center">
                                    <i data-lucide="map-minus" class="w-5 h-5 mr-2 text-yellow-600"></i>
               ...
               <div class="bubble-wrapper absolute inset-0 z-0 pointer-events-none">
                ...
                <div class="flex justify-center items-center w-full h-screen pt-10 pb-10">
                    <div class="overflow-y-auto max-h-screen px-4 min-h-0">
                        <h1 style="font-family: 'Sacramento', cursive; font-size: 34px;" class="text-center text-gray-800">Our Story</h1>
        ...
        <div class="flex justify-center items-center mt-5 mb-5 text-gray-800">
                ...
                <div class="w-full flex justify-center items-center fade-scroll">
                    <form action="{{route('kirim_pesan')}}" method="post">
                        ...
                        <div class="w-full p-2">
                            <label>Nama</label>
                            <input type="hidden" name="slug" value="{{$undangan->slug}}" class="w-full bg-white border-gray-500 outline-1 decoration-0 hover:border-2 hover:border-yellow-500 py-1.5 px-3 rounded-lg">
                            <input type="hidden" name="kode_pesan" value="{{$undangan->kode_pesan}}" class="w-full bg-white border-gray-500 outline-1 decoration-0 hover:border-2 hover:border-yellow-500 py-1.5 px-3 rounded-lg">
                            <input type="text" name="nama" class="w-full bg-white border-gray-500 outline-1 decoration-0 hover:border-2 hover:border-yellow-500 py-1.5 px-3 rounded-lg">
                        </div>
                        <div class="w-full p-2">
                            <label>Pesan</label>
                            <textarea  class="w-full bg-white border-gray-500 outline-1 decoration-0 hover:border-2 hover:border-yellow-500 py-1.5 px-3 rounded-lg" name="pesan"></textarea>
                        </div>
                        <div class="w-full p-2">
                            <button type="submit" class="py-1.5 px-4 rounded-xl bg-yellow-300 hover:bg-yellow-500 text-gray-100">Kirim</button>
                        </div>
                    </form>
                </div>
