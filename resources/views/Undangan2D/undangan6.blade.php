<meta charset="utf-8">
    ...
    <style>
        ...
        .bg-cover1 {
            background-image: url('/images/bg_biru.png');
        ...
        .bunga {
            background-image: url('/images/bunga_biru.png');
            background-repeat: no-repeat;
...
<body class="overflow-x-hidden lock-scroll">
    ...
    <section id="cover">
        <div class="w-full flex justify-center">
            <div class="relative bg-cover1 w-full md:w-6/12 h-screen overflow-hidden z-10">
                ...
                <!-- DAUN TOP -->
                <div class="absolute -top-5 -left-5 bunga w-56 h-56 md:w-96 md:h-96 opacity-70 rotate-90"
                    style="animation-name: angin-top; animation-delay: 0.5s;"></div>
                <div class="absolute -top-5 -right-5 bunga w-56 h-56 md:w-96 md:h-96 opacity-70 rotate-180"
                    style="animation-name: angin-top; animation-delay: 0.5s;"></div>

                {{-- Daun Bottom --}}
                <div class="absolute -bottom-5 -left-5 bunga w-56 h-56 md:w-96 md:h-96 opacity-70 rotate-0"
                    style="animation-name: angin-top; animation-delay: 0.5s;"></div>
                <div class="absolute -bottom-5 -right-5 bunga w-56 h-56 md:w-96 md:h-96 opacity-70 rotate-270"
                    style="animation-name: angin-top; animation-delay: 0.5s;"></div>
               
                <div class="w-full h-screen flex justify-center items-center">
                    <div>
                        <div class="w-full flex justify-center items-center opacity-0 animate-fadeCover">
                            <h1 class="text-amber-300 mt-4">HAPPY WEDDING</h1>
                        </div>
                        <div class="w-full flex justify-center items-center opacity-0 animate-fadeCover">
                            <h1 class="text-amber-300" style="font-family: 'Great Vibes', cursive; font-size: 44px;">
                                Wedding Of
                            </h1>
                        </div>
                        ...
                        <div class="w-full flex justify-center items-center opacity-0 animate-fadeCover -mt-1">
                            <div>
                                <div class="flex justify-center items-center">
                                    <p class="text-amber-300 text-lg">Kepada Yth. Bapak/Ibu/Saudara/i</p>
                                </div>
                                <div class="flex justify-center items-center">
                                    <p class="text-amber-300 text-xl font-bold">{{$tamu}}</p>
                                </div>
                        ...
                        <div class="mt-2 w-full flex justify-center items-center opacity-0 animate-fadeCover text-amber-200">
                            <a href="#isi_undangan" id="btnBuka" class="bg-amber-600 hover:bg-amber-500 p-3 rounded-lg flex justify-center items-center">
    ...
    <section id="isi_undangan" class="hidden">
                ...
                <div class="w-full h-screen flex justify-center items-center">
                    <div>
                        <div class="opacity-0 fade-scroll flex justify-center items-center">
                            <h1 class="text-amber-300" style="font-family: 'Great Vibes', cursive; font-size: 24px;">
                                The Wedding Of
                            </h1>
                        </div>
                        <div class="opacity-0 fade-scroll flex justify-center items-center">
                        ...
                        <div class="opacity-0 fade-scroll flex justify-center items-center">
                            <h1 class="text-amber-300 text-xl">
                                {{ \Carbon\Carbon::parse($undangan->tgl_akad)->locale('id')->translatedFormat('l, d F Y') }}
                            </h1>
                        </div>
                        <div class="flex justify-center items-center">
                            ...
                            <div>
                                <div id="countdown" class="mt-2 fade-scroll flex justify-center items-center text-xl md:text-3xl font-bold"></div>
                                    <div class="grid grid-cols-4 gap-4">
                                        <div class="opacity-0 fade-scroll bg-amber-300 scale-anim w-18 h-18 p-1 font-bold text-amber-600 rounded-tl-xl rounded-br-xl flex justify-center items-center">
                                            <div class="flex justify-center items-center">
                                                <div>
                                                    <p id="days">0</p>
                                                    <p>Days</p>
                        ...
                        <div class="flex justify-center items-center mt-10">
                            <div class="opacity-0 fade-scroll bg-amber-300 rounded-xl p-3 text-amber-700 font-bold">
        ...
        <div class="w-full flex justify-center items-center">
            <div class="relative bg-cover1 w-full md:w-6/12 h-screen overflow-hidden z-10">
               <div class="bubble-wrapper absolute inset-0 z-0 pointer-events-none">
                ...
                <div class="absolute -bottom-5 -right-5 bunga w-56 h-56 md:w-96 md:h-96 opacity-70 rotate-270"
                    style="animation-name: angin-top; animation-delay: 0.5s;"></div>
                <div class="flex justify-center items-center w-full h-screen text-amber-400">
                    <div>
                        <div class="flex justify-center -mt-10 text-amber-400 mb-2">
                            <svg class="w-24 h-auto fill-current" xmlns="http://www.w3.org/2000/svg" xml:space="preserve" width="100mm" height="40mm" version="1.1" style="shape-rendering:geometricPrecision; text-rendering:geometricPrecision; image-rendering:optimizeQuality; fill-rule:evenodd; clip-rule:evenodd"
                        ...
                        <div class="opacity-0 fade-scroll flex justify-center items-center text-center mb-5">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-7">
                                    ...
                                    <div>
                                        ...
                                        <div class="flex justify-center items-center">
                                            <div class="mt-6">
                                                ...
                                                <div class="mt-1">
                                                    <div class="flex justify-center items-center">
                                                        <div class="fade-scroll w-5 h-5 md:w-10 md:h-10 rounded-full overflow-hidden ring-2 ring-white/40 shadow-2xl text-amber-400">
                                                        ...
                                                        <div class="fade-scroll w-5 h-5 md:w-10 md:h-10 rounded-full overflow-hidden ring-2 ring-white/40 shadow-2xl ml-2 text-amber-400">
                            ...
                            <div class="flex justify-center items-center mb-5 -mt-1">
                                            ...
                                            <div class="p-2">
                                                ...
                                                <div class="mb-3 mt-1">
                                                    <div class="flex justify-center items-center">
                                                        ...
                                                        <div class="fade-scroll w-5 h-5 md:w-10 md:h-10 rounded-full overflow-hidden ring-2 ring-white/40 text-amber-400 shadow-2xl ml-2">
        ...
        <div class="w-full flex justify-center items-center">
            <div class="relative bg-cover1 w-full md:w-6/12 h-screen overflow-hidden z-10">
               <div class="bubble-wrapper absolute inset-0 z-0 pointer-events-none">
                ...
                <div class="absolute -bottom-5 -right-5 bunga w-56 h-56 md:w-96 md:h-96 opacity-70 rotate-270"
                    style="animation-name: angin-top; animation-delay: 0.5s;"></div>
                <div class="flex justify-center items-center w-full h-screen text-center text-amber-400">
                    <div class="grid grid-cols-1 gap-1.5 w-10/12">
                        <div class="rounded-xl p-2 shadow-2xl fade-scroll">
                            ...
                            <p class="text-lg md:text-xl text-amber-900 mt-2 mb-2">BERTEMPAT DI</p>
                            <p class="text-[9px] md:text-lg">{{$undangan->alamat_akad}}</p>
                            
                            <div class="flex justify-center items-center">
                                <a href="{{$undangan->maps_akad}}" class="mt-1 px-0.5 py-1.5 w-8/12 rounded-xl bg-amber-400 flex justify-center items-center">
                                    <i data-lucide="map-minus" class="w-5 h-5 mr-2 text-amber-600"></i>
                                    <span class="text-amber-600">Buka Google Lokasi</span>
                                </a>
                            </div>
                        ...
                        <div class="rounded-xl p-2 shadow-2xl mt-5 mb-5 fade-scroll">
                            ...
                            <div class="flex justify-center items-center">
                                <a href="{{$undangan->maps_resepsi}}" class="mt-1 px-0.5 py-1.5 w-8/12 rounded-xl bg-amber-400 flex justify-center items-center">
                                    <i data-lucide="map-minus" class="w-5 h-5 mr-2 text-amber-600"></i>
                                    <span class="text-amber-600">Buka Google Lokasi</span>
                                </a>
                            </div>
               ...
               <div class="bubble-wrapper absolute inset-0 z-0 pointer-events-none">
                ...
                <div class="flex justify-center items-center w-full h-screen pt-10 pb-10">
                    <div class="overflow-y-auto max-h-screen px-4 min-h-0">
                        <h1 style="font-family: 'Sacramento', cursive; font-size: 34px;" class="text-center text-amber-400">Our Story</h1>

                        <div class="relative border-l-4 border-amber-500 pl-6 space-y-4 ml-2">

                            <!-- Item -->
                            <div class="timeline-item opacity-0 translate-y-10 transition-all duration-700">
                                <div class="flex justify-start mr-2">
                                    <div class="w-12 h-12 rounded-full bg-amber-400 flex text-amber-100 justify-center items-center mr-3"><i data-lucide="heart"></i></div>
        ...
        <div class="flex justify-center items-center mt-5 mb-5 text-amber-400">
        ...
        <div class="flex justify-center items-center text-amber-400">
                ...
                <div class="w-full flex justify-center items-center fade-scroll">
                    <form action="{{route('kirim_pesan')}}" method="post">
                        ...
                        <div class="w-full p-2">
                            <label>Nama</label>
                            <input type="hidden" name="slug" value="{{$undangan->slug}}" class="w-full bg-white border-gray-500 outline-1 decoration-0 hover:border-2 hover:border-amber-500 py-1.5 px-3 rounded-lg">
                            <input type="hidden" name="kode_pesan" value="{{$undangan->kode_pesan}}" class="w-full bg-white border-gray-500 outline-1 decoration-0 hover:border-2 hover:border-amber-500 py-1.5 px-3 rounded-lg">
                            <input type="text" name="nama" class="w-full bg-white border-gray-500 outline-1 decoration-0 hover:border-2 hover:border-amber-500 py-1.5 px-3 rounded-lg">
                        </div>
                        <div class="w-full p-2">
                            <label>Pesan</label>
                            <textarea  class="w-full bg-white border-gray-500 outline-1 decoration-0 hover:border-2 hover:border-amber-500 py-1.5 px-3 rounded-lg" name="pesan"></textarea>
                        </div>
                        <div class="w-full p-2">
                            <button type="submit" class="py-1.5 px-4 rounded-xl bg-amber-300 hover:bg-amber-500 text-gray-100">Kirim</button>
                        </div>
                    </form>
                </div>
                ...
                <div class="flex justify-center items-center fade-scroll">
                    <div class="mt-4 bg-white rounded-xl shadow-2xl p-3 w-full md:w-6/12">
                        ...
                        <div class="flex justify-center items-center mt-2">
                            <button onclick="openModal()" class="py-1.5 px-4 rounded-xl bg-gray-300 hover:bg-gray-500 text-gray-200">Konfirmasi Kehadiran</button>
                        </div>
                    </div>
                </div>
        ...
        <div class="flex justify-center items-center">
            <div class="relative w-full md:w-6/12 h-screen flex items-center justify-center overflow-hidden">
                ...
                <div class="absolute inset-0 bg-amber-200/40"></div>
    ...
    <div class="fixed bottom-2 opacity-40 left-1/2 -translate-x-1/2 z-50">
        <button id="musicBtn"
            ...
            <svg id="musicIcon" xmlns="http://www.w3.org/2000/svg"
                class="w-6 h-6 text-amber-600" fill="currentColor"
                viewBox="0 0 24 24">
    ...
    <div id="modalKehadiran" 
        ...
        <div id="modalBoxKehadiran"
            ...
            <form action="{{route('konfirmasi_kehadiran')}}" method="post">
                ...
                <div class="w-full p-2">
                    <label>Nama</label>
                    <input type="hidden" name="slug" value="{{$undangan->slug}}" class="w-full bg-gray-200 border-none decoration-0 hover:border-2 hover:border-gray-500 py-1.5 px-3 rounded-lg">
                    <input type="hidden" name="kode_pesan" value="{{$undangan->kode_pesan}}" class="w-full bg-gray-200 border-none decoration-0 hover:border-2 hover:border-gray-500 py-1.5 px-3 rounded-lg">
                    <input type="text" name="nama" class="w-full bg-gray-200 border-none decoration-0 hover:border-2 hover:border-gray-500 py-1.5 px-3 rounded-lg">
                </div>
                <div class="w-full p-2">
                    <label>Konfirmasi</label>
                    <select name="konfirmasi_kehadiran" class="w-full bg-gray-200 border-none decoration-0 hover:border-2 hover:border-gray-500 py-1.5 px-3 rounded-lg">
                        <option>Ya, Saya Akan Hadir</option>
                        <option>Maaf, Saya Tidak Bisa Hadirr</option>
                    </select>
                </div>
                <div class="w-full p-2">
                    <button type="submit" class="py-1.5 px-4 rounded-xl bg-gray-300 hover:bg-gray-500 text-gray-100">Kirim</button>
                </div>
            </form>
        </div>
    </div>
               ...
               <div class="bubble-wrapper absolute inset-0 z-0 pointer-events-none">
                ...
                <div class="w-full h-screen flex justify-center items-center">
                    <div>
                        ...
                        <div class="w-full flex justify-center items-center opacity-0 animate-fadeCover">
                            <h1 class="text-gray-600" style="font-family: 'Sacramento', cursive; font-size: 64px;">
                                Wedding Of
                            </h1>
                        </div>
                        <div class="w-full flex justify-center items-center">
                        ...
                        <div class="w-full flex justify-center items-center opacity-0 animate-fadeCover">
                            <div>
                                ...
                                <div class="flex justify-center items-center">
                                    <p class="text-gray-800 text-xl font-bold">Nama Tamu</p>
                                </div>
                                <div class="flex justify-center items-center text-center">
                        ...
                        <div class="mt-5 mb-5 w-full flex justify-center items-center opacity-0 animate-fadeCover">
                            <a href="#isi_undangan" id="btnBuka" class="bg-gray-400 hover:bg-gray-300 p-3 rounded-lg flex justify-center items-center">
                                <i data-lucide="mail-open" class="w-5 h-5 mr-2"></i>
    ...
    <section id="isi_undangan" class="hidden">
            ...
            <div class="relative bg-cover1 w-full md:w-6/12 h-screen overflow-hidden z-10">
               <div class="bubble-wrapper absolute inset-0 z-0 pointer-events-none">
                ...
                <div class="w-full h-screen flex justify-center items-center">
                    <div>
                        <div class="opacity-0 fade-scroll flex justify-center items-center">
                            <h1 class="text-gray-600" style="font-family: 'Sacramento', cursive; font-size: 24px;">
                                The Wedding Of
                            </h1>
                        </div>
                        <div class="opacity-0 fade-scroll flex justify-center items-center">
                        ...
                        <div class="opacity-0 fade-scroll flex justify-center items-center">
                            <div class="grid grid-cols-3 gap-3 leading-tight">
                                ...
                                <div class="text-sm md:text-xl font-extrabold border-r-2 border-l-2 border-gray-800 p-4">
                                    <div class="flex justify-center items-center">
                                        <p>28</p>
                                    </div>
                                    <div class="flex justify-center items-center">
                        ...
                        <div class="flex justify-center items-center mt-20">
                            ...
                            <div class="grid grid-cols-4 gap-4">
                                <div class="opacity-0 fade-scroll bg-gray-700 scale-anim w-18 h-18 p-1 font-bold text-white rounded-tl-xl rounded-br-xl flex justify-center items-center">
                                    <div class="flex justify-center items-center">
                                        <div>
                                            <p id="days">0</p>
                                            <p>Days</p>
                        ...
                        <div class="flex justify-center items-center mt-10">
                            <div class="opacity-0 fade-scroll bg-gray-600 rounded-xl p-3 text-white font-bold">
                ...
                <div class="grid grid-cols-1 md:grid-cols-7 md:mt-16 mt-0.5">
                    <div class="col-span-3">
                        <div class="flex justify-center">
                            <div>
                                <div class="flex justify-center items-center">
                                    <div class="fade-scroll w-44 h-48 md:w-64 md:h-72 rounded-b-full overflow-hidden ring-[14px] ring-white/40 shadow-2xl">
                                ...
                                <div class="flex justify-center items-center">
                                    <div class="mt-6">
                                        ...
                                        <div class="opacity-0 fade-scroll flex justify-center items-center text-center">
                    ...
                    <div class="col-span-3">
                        <div class="flex justify-center">
                            <div>
                                ...
                                <div class="flex justify-center items-center">
                                    <div class="fade-scroll w-44 h-48 md:w-64 md:h-72 rounded-t-full overflow-hidden ring-[14px] ring-white/40 shadow-2xl">
                ...
                <div class="flex justify-center items-center mt-24 text-center">
                    <div class="grid grid-cols-1 gap-1.5 w-10/12">
                        <div class="rounded-xl p-2 shadow-2xl fade-scroll">
                            ...
                            <p class="text-lg md:text-xl text-gray-900 mt-2 mb-2">BERTEMPAT DI</p>
                            <p class="text-md md:text-lg">Kediaman Mempelai Wanita Cangkuang RT. 2 RW. 2 Desa Cangkuang Kec. Cangkuang, Kab. Bandung</p>
                            
                            <div class="flex justify-center items-center">
                                <a href="" class="mt-5 px-2 py-4 w-8/12 rounded-xl bg-gray-400 flex justify-center items-center">
            ...
            <div class="relative bg-cover1 w-full md:w-6/12 h-screen overflow-hidden z-10">
               <div class="bubble-wrapper absolute inset-0 z-0 pointer-events-none">
                ...
                <div class="max-w-4xl mx-auto py-20">
                    ...
                    <div class="relative border-l-4 border-gray-500 pl-8 space-y-16 ml-2">

                        <!-- Item -->
                        <div class="timeline-item opacity-0 translate-y-10 transition-all duration-700">
                            <div class="flex justify-start mr-2">
                                <div class="w-12 h-12 rounded-full bg-gray-400 flex text-gray-100 justify-center items-center mr-3"><i data-lucide="heart"></i></div>
                                <div class="rounded-xl w-full p-2 shadow-2xl bg-white opacity-40 text-xs">
                                    <p>2021</p>
            ...
            <div class="w-full md:w-6/12 bg-white">
                ...
                <div class="w-full flex justify-center items-center fade-scroll">
                    <form action="" method="post">
                        ...
                        <div class="w-full p-2">
                            <label>Nama</label>
                            <input type="text" name="nama" class="w-full bg-white border-gray-500 outline-1 decoration-0 hover:border-2 hover:border-gray-500 py-1.5 px-3 rounded-lg">
                        </div>
                        <div class="w-full p-2">
                            <label>Pesan</label>
                            <textarea  class="w-full bg-white border-gray-500 outline-1 decoration-0 hover:border-2 hover:border-gray-500 py-1.5 px-3 rounded-lg" name="pesan"></textarea>
                        </div>
                        <div class="w-full p-2">
                            <button type="submit" class="py-1.5 px-4 rounded-xl bg-gray-300 hover:bg-gray-500 text-gray-100">Kirim</button>
                        </div>
        ...
        <div class="flex justify-center items-center">
            <div class="relative w-full md:w-6/12 h-screen flex items-center justify-center overflow-hidden">
                ...
                <!-- Overlay warna lembut -->
                <div class="absolute inset-0 bg-green-200/40"></div>
    ...
    <div id="modalKehadiran" 
        ...
        <div id="modalBoxKehadiran"
            ...
            <form action="{{route('admin.store')}}" method="post">
                ...
                <div class="w-full p-2">
                    <label>Konfirmasi</label>
                    <select class="w-full bg-gray-200 border-none decoration-0 hover:border-2 hover:border-gray-500 py-1.5 px-3 rounded-lg">
                        <option>Ya, Saya Akan Hadir</option>
                        <option>Maaf, Saya Tidak Bisa Hadirr</option>
                    </select>
                </div>
