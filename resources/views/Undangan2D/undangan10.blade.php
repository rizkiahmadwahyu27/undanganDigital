<meta charset="utf-8">
    ...
    <style>
        ...
        @keyframes profesionalGlow {
            ...
            box-shadow: 0 0 20px 4px rgba(253, 224, 71, 0.3);
            }
        }

        .animate-glow-profesional {
            animation: profesionalGlow 3s infinite ease-in-out;
        }
        }
    ...
    <section id="isi_undangan" class="hidden">
        <div class="w-full h-screen overflow-hidden flex justify-center bg-zinc-900">
            ...
            <div class="relative w-full md:w-6/12 h-full bg-cover1 flex justify-center overflow-hidden shadow-2xl">
                ...
                <button data-name="maps" class="icon absolute top-[34%] right-[30%] w-[9%] h-[7%] md:right-[37%] md:w-[7%] rounded-xl cursor-pointer transition-all duration-500 ease-out border border-white/0 hover:border-yellow-300/40 hover:bg-white/10 hover:backdrop-blur-[1px] animate-glow-profesional hover:scale-105 active:scale-95 focus:outline-none"></button>

                <button data-name="guest" class="icon absolute top-[33%] left-[3%] w-[5%] h-[12%] md:left-[23%] md:w-[3%] rounded-lg cursor-pointer transition-all duration-500 ease-out border border-white/0 hover:border-yellow-300/40 hover:bg-white/10 hover:backdrop-blur-[1px] animate-glow-profesional hover:scale-105 active:scale-95 focus:outline-none"></button>

                <button data-name="daftarTamu" class="icon absolute top-[34%] left-[13%] w-[12%] h-[8%] md:left-[28%] md:w-[7%] rounded-xl cursor-pointer transition-all duration-500 ease-out border border-white/0 hover:border-yellow-300/40 hover:bg-white/10 hover:backdrop-blur-[1px] animate-glow-profesional hover:scale-105 active:scale-95 focus:outline-none"></button>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function () {
            ...
            function openModal(name) {
                // Mencari id="modal-story" atau id="modal-gallery"
                const modal = document.getElementById('modal-' + name);

                if (!modal) {
                    console.error('Modal tidak ditemukan:', 'modal-' + name);
                    return;
                }
            ...
            // klik tombol area / icon
            document.querySelectorAll('.icon').forEach(el => {
                el.addEventListener('click', function () {
                    const name = this.dataset.name;
                    const label = this.querySelector('div');

                    // Proteksi: Hanya jalankan animasi label jika elemen <div> labelnya memang ada
                    if (label) {
                        ...
                        // Jika tidak ada label (seperti tombol transparan Anda), langsung buka modal
                        openModal(name);
                    }
                });
            });

            // Biar tombol close tetap bisa dipakai di inline onclick="closeModal()"
